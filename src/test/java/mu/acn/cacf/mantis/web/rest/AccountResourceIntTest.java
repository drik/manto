...
import mu.acn.cacf.mantis.config.Constants;
import mu.acn.cacf.mantis.MantoApp;
import mu.acn.cacf.mantis.domain.Authority;
import mu.acn.cacf.mantis.domain.User;
import mu.acn.cacf.mantis.repository.AuthorityRepository;
import mu.acn.cacf.mantis.repository.UserRepository;
import mu.acn.cacf.mantis.security.AuthoritiesConstants;
import mu.acn.cacf.mantis.service.MailService;
import mu.acn.cacf.mantis.service.dto.UserDTO;
import mu.acn.cacf.mantis.web.rest.errors.ExceptionTranslator;
import mu.acn.cacf.mantis.web.rest.vm.KeyAndPasswordVM;
import mu.acn.cacf.mantis.web.rest.vm.ManagedUserVM;
import mu.acn.cacf.mantis.service.UserService;
...
@SpringBootTest(classes = MantoApp.class)
