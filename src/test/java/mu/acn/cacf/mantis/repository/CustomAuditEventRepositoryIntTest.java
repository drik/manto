...
import mu.acn.cacf.mantis.config.audit.AuditEventConverter;
import mu.acn.cacf.mantis.domain.PersistentAuditEvent;
...
import static mu.acn.cacf.mantis.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
